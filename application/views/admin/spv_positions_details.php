					...
					<form action="<?php echo base_url(); ?>spv/update_positions" method="post" enctype="multipart/form-data" id="add_position" name="add_position" class="form">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="tTitle" name="tTitle" placeholder="Title (Tamil)" value="<?php echo html_escape($spv_position_details->title_ta);?>" maxlength="100">
							</div>
							<div class="form-group col-md-6">
								<label class="col-form-label">Position Title (English)</label>
								<input type="text" class="form-control" id="eTitle" name="eTitle" placeholder="Title (English)" value="<?php echo html_escape($spv_position_details->title_en);?>" maxlength="100">
							</div>						
						</div>
