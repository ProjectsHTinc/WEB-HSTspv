					...
					<h4 class="page-title">List Application Users</h4><hr>				
							<table id="datatable" class="table table-bordered  nowrap">
                                        ...
                                        <tr>
											...
											<td style="text-align:center;"><a data-toggle="tooltip" title="Edit" href="<?php echo base_url(); ?>users/app_user_details/<?php echo base64_encode($rows->id*98765); ?>/">Edit</a></td>
                                        </tr>
										<?php $i++; } ?>
                                        </tbody>
                                    </table>
