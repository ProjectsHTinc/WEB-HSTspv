<div class="content">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card-box">
				<h4 class="header-title mt-0">Notable Works</h4><hr>
...
<?php } ?>
					<form action="<?php echo base_url(); ?>spv/add_notableworks" method="post" enctype="multipart/form-data" id="add_position" name="add_position" class="form">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card-box">	
				<h4 class="page-title">List Works</h4><hr>
							<table id="datatable" class="table table-bordered  nowrap">
                                        <thead>
                                        <tr>
                                            <th width="5%">#</th>
											<th width="80%">Work Title</th>
                                        ...
                                        <tr>
											...
											<td style="text-align:center;"><a data-toggle="tooltip" title="Edit" href="<?php echo base_url(); ?>spv/notableworks_details/<?php echo base64_encode($rows->id*98765); ?>/">Edit</a></td>
                                        </tr>
										<?php $i++; } ?>
                                        </tbody>
                                    </table>
