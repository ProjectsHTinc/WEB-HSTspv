				...
				<h4 class="page-title">List Works</h4><hr>
							<table id="datatable" class="table table-bordered  nowrap">
                                        ...
                                        <tr>
											...
											<td style="text-align:center;"><a data-toggle="tooltip" title="View" href="<?php echo base_url(); ?>spv/notableworks_details/<?php echo base64_encode($rows->id*98765); ?>/">Edit</a></td>
                                        </tr>
										<?php $i++; } ?>
                                        </tbody>
                                    </table>
